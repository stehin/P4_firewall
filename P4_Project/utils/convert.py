...
def packetin_decode(packet):
    mac_dst_addr=decodeMac(packet[0:6])
...
def from_base64_to_decimal(stringa):
    data=base64.b64decode(stringa)
    numero=decodeNum(data)
    return numero

def from_base64_to_ipv4(stringa):
    data=base64.b64decode(stringa)
    address=decodeIPv4(data)
    return address
